...
class AutoLocalizer(Node):
    ...
    def run_sequence(self):
        ...
        self.get_logger().info('Service found. Reinitializing global localization (scattering particles)...')
        req = Empty.Request()
        ...
        msg.linear.x = 0.0
        self.cmd_pub.publish(msg)
        self.get_logger().info('Auto localization sequence completed! Robot should now be localized.')
